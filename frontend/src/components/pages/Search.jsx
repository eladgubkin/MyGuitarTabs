...
import svgPaletteOutline from '../../assets/svg/palette-outline.svg';
                ...
                return (
                  <div
                    ...
                    onClick={e => {
                      // Get text from html
                      const type =
                        e.currentTarget.parentElement.previousSibling.childNodes[0]
                          .textContent;
                      const name = e.currentTarget.children[1].textContent;

                      return props.history.push(`/search/${type}/${name}/`);
                    }}
                  >
